...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProjectApi.DefaultApi();
  });
  ...
  describe('DefaultApi', function() {
    ...
    describe('findProjects', function() {
      it('should call findProjects successfully', function(done) {
        //uncomment below and update the code to test findProjects
        //instance.findProjects(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
